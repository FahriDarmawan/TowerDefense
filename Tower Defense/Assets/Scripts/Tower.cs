...
public class Tower : MonoBehaviour
{
    ...
    private Quaternion _targetRotatiion;
    ...
    //Fungsi yang digunakan untuk mengambill sprite pada tower head
    ...
    //Mengubar order in layer pada tower yang sedang di drag
    ...
    //Menembak musuh yang telah tersimpan sebagai target
    public void ShootTarget()
    {
        ...
        {
            bool headHasAimed = Mathf.Abs(_towerHead.transform.rotation.eulerAngles.z - _targetRotatiion.eulerAngles.z) < 10f;
    ...
    public void SeekTarget()
    {
        ...
        _targetRotatiion = Quaternion.Euler(new Vector3(0f, 0f, targetAngle - 90f));

        _towerHead.transform.rotation = Quaternion.RotateTowards(_towerHead.transform.rotation, _targetRotatiion, Time.deltaTime * 180f);
    }
